...
namespace www.yasinkaya.org.Services.Abstract
{
    public interface IArticleService
    {
        ...
        Task<IDataResult<ArticleListDto>> GetAllByUserIdOnFilterAsnyc(int userId, FilterBy filterBy, OrderBy orderBy, bool isAscending, int takeSize, int categoryId, DateTime startAt, DateTime endAt, int minViewCount, int maxViewCount, int minCommentCount, int maxCommentCount);
